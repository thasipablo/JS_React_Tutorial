...
# 📖 JS_React_Tutorial <a name="about-project"></a>

**JS_React_Tutorial** is a JavaScript learning demo project.
...
```sh
  git clone git@github.com:thasipablo/JS_React_Tutorial.git
  cd JS_React_Tutorial
```
...
Feel free to check the [issues page](https://github.com/thasipablo/JS_React_Tutorial/issues).
